...
describe('Hue API', function () {
  ...
  describe('#config', function () {
    ...
    function validateConfigResults(results) {
      ...
      // expect(results).to.have.property('swupdate'); //deprecated field
      expect(results).to.have.property('swupdate2');
  ...
  describe('description', function () {
    ...
    function validateDescription(desc) {
      ...
      expect(desc).to.have.property('manufacturer').to.equal('Signify');
